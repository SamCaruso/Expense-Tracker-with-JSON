...
def add_item(type, type_dict):
    while True:
        ...
        # I want items to be displayed chronologically (from first added to last), not alphabetically
        if description == EXIT:
            return
        else:
            while True:
...
def main():
    ...
    while True:
        budget = to_do(expenses, credit, init_budget,
                       budget, saved_expenses_json)
